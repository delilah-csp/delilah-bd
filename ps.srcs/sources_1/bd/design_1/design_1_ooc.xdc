...
create_clock -name diff_clock_rtl_1_clk_p -period 10 [get_ports diff_clock_rtl_1_clk_p]
create_clock -name diff_clock_rtl_2_clk_p -period 3.333 [get_ports diff_clock_rtl_2_clk_p]
create_clock -name diff_clock_rtl_3_clk_p -period 3.333 [get_ports diff_clock_rtl_3_clk_p]
