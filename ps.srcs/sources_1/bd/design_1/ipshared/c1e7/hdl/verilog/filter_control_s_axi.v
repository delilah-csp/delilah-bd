...
#(parameter
    ...
    output wire [63:0]                   op,
    output wire [31:0]                   comp1,
    output wire [31:0]                   comp2
);
//------------------------Address Info-------------------
...
localparam
    ...
    ADDR_COMP1_CTRL   = 7'h50,
    ADDR_COMP2_DATA_0 = 7'h54,
    ADDR_COMP2_CTRL   = 7'h58,
    WRIDLE            = 2'd0,
    WRDATA            = 2'd1,
    WRRESP            = 2'd2,
    WRRESET           = 2'd3,
...
//------------------------Local signal-------------------
    ...
    reg  [63:0]                   int_num = 'b0;
    reg  [63:0]                   int_op = 'b0;
    reg  [31:0]                   int_comp1 = 'b0;
    reg  [31:0]                   int_comp2 = 'b0;
