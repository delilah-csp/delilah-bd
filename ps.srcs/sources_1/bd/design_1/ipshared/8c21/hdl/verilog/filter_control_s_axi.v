...
localparam
    ...
    ADDR_IN_R_DATA_0  = 7'h18,
    ADDR_IN_R_DATA_1  = 7'h1c,
    ADDR_IN_R_CTRL    = 7'h20,
    ADDR_OUT_R_DATA_0 = 7'h24,
    ADDR_OUT_R_DATA_1 = 7'h28,
    ADDR_OUT_R_CTRL   = 7'h2c,
    ADDR_NUM_DATA_0   = 7'h30,
    ADDR_NUM_CTRL     = 7'h34,
    ADDR_OP_DATA_0    = 7'h38,
    ADDR_OP_CTRL      = 7'h3c,
    ADDR_COMP1_DATA_0 = 7'h40,
    ADDR_COMP1_CTRL   = 7'h44,
    ADDR_COMP2_DATA_0 = 7'h48,
    ADDR_COMP2_CTRL   = 7'h4c,
    WRIDLE            = 2'd0,
    WRDATA            = 2'd1,
    WRRESP            = 2'd2,
    WRRESET           = 2'd3,
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_OP_DATA_0)
            int_op[7:0] <= (WDATA[31:0] & wmask) | (int_op[7:0] & ~wmask);
    end
end
